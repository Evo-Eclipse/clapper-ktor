 ...
 */
class TransitionTablePropertyTest : FunSpec({

    test("Property 1: Допустимые переходы FSM соответствуют таблице — " +
    ...
    test("Property 2: Запрещённые переходы сохраняют состояние — " +
